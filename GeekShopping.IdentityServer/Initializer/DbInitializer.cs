...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "adriana-admin",
                Email = "pereira.adri@gmail.com",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Adriana123+").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "brazuk25@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (47) 78945-1235",
                FirstName = "Rodrigo",
                LastName = "Mora"
            };
